...
<div id="header-wrap" class="clr fixed-header">
    <div id="preface-header-first" class="container clr"><?php print render($page['preface_header_first']); ?></div>
...
<div id="wrap" class="clr">
    ...
    <div id="homepage-slider" class="flexslider">
      <ul class="slides clr">
        ...
        <li>
		 ...
		 <li>
          <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/eco.png'; ?>">
        </li>
  ...
  <div id="preface-wrap" class="site-preface clr">
    <div id="preface" class="container clr">
...
<?php if ($page['pre-pre-main']): ?>
  <?php print render($page['pre-pre-main']); ?>
 <?php endif; ?>
  
  
<?php if ($page['pre-main0']): ?>
  <?php print render($page['pre-main0']); ?>
 <?php endif; ?>
 
 <?php if ($page['pre-main1']): ?>
  <?php print render($page['pre-main1']); ?>
 <?php endif; ?>


  <div id="main" class="container site-main clr">
...
<?php if ($page['middle00']): ?>
  
          <?php print render($page['middle00']); ?>
  <?php endif; ?>
  
  
<?php if ($page['middle01']): ?> 
	
	  <?php print render($page['middle01']); ?>
...
<?php if ($page['middle']): ?>
  ...
  <?php if ($page['middle1']): ?>
	<?php print render($page['middle1']); ?>
  <?php endif; ?>
  
  <?php if ($page['middle2']): ?>
	<?php print render($page['middle2']); ?>
  <?php endif; ?>
	...
	<div class="container">
      <?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third']): ?>
        <div id="footer-block-wrap" class="clr">
          <?php if($page['footer_first']): ?><div class="span_2_of_4 col col-1 footer-block ">
            <?php print render ($page['footer_first']); ?>
          </div><?php endif; ?>
          <?php if($page['footer_second']): ?><div class="span_1_of_4 col col-2 footer-block ">
            <?php print render ($page['footer_second']); ?>
          </div><?php endif; ?>
          <?php if($page['footer_third']): ?><div class="span_1_of_4 col col-3 footer-block ">
