...
<div id="wrap" class="clr container">
  <div id="header-wrap" class="blog-header-wrap clr fixed-header">
    <header id="header" class="clr">
<!--<link href='https://fonts.googleapis.com/css?family=Roboto:400,900,400italic,700italic' rel='stylesheet' type='text/css'>	-->
      ...
      <?php endif; ?>
	  <div id="contacto" class="clr">
	  <ul>
	  <li>Hospital San Rafael (Madrid)</li>
	  <li>Unidad de fisioterapia suelo pélvico, servicio de urología.</li>
	  <li>ams@fisioterapiasuelopelvico.com</li>
  ...
  <div id="main" class="blog-main clr">
    ...
    <div id="primary" class="content-area clr">
      <section id="content" role="main" class="site-content <?php print $sidebarclass; ?> clr">
        ...
        <div id="content-wrap">
		  ...
		  <div class="span_3_of_4 col-1 col">
          <?php print render($page['content']); ?>
		  </div>
		  <div class="span_1_of_4 col-2 col">
		  </div>
        </div>
      </section>
